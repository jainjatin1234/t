...
import img1 from '../../img/electronics.jpeg'
...
const ProductDetail = () => {
  ...
  const {loading, error, productdetails} = useSelector(state => state.pdetail)
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                        ...
                        <div >
                            <img class="w-100 h-100" src={productdetails?.image?.url} alt="Image"/>
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style={{width: "130px"}}>
                            <div class="input-group-btn">
                                <button onClick={decreaseQty} class="btn btn-primary btn-minus">
                                    <i class="fa fa-minus"></i>
                                </button>
                            </div>
                            <input type="text" class="form-control bg-secondary border-0 text-center" value={quantity}/>
                            <div class="input-group-btn">
                                <button onClick={increaseQty} class="btn btn-primary btn-plus">
                                    <i class="fa fa-plus"></i>
                                </button>
                            </div>
                        </div>
                        <Link to='/cart'>
                        <button class="btn btn-primary px-3" onClick={addtoCartHandler} >
